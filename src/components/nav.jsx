    ...
    <div className="flex items-center justify-between p-10 lg:flex-row">
      ...
      <div className="space-x-4">
        ...
        <div className='ssm:block lg:hidden'>
          {toggle ? (
            <AiOutlineClose size={30} className='text-white cursor-pointer'  onClick={closeMenu}/>
          ) : <HiMenuAlt1 size={30} className='text-white' onClick={openMenu}/>}
